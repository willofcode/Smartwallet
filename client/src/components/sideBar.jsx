...
const Sidebar = () => {
  ...
  const fetchUserName = async (id) => {
    try {
      ...
      setUserName(response.data.firstName || 'User'); /// make this such that it 
      localStorage.setItem('userName', response.data.firstName); // <--- this is how we store the userId in local storage
